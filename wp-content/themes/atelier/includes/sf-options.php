...
//								'loading-bar'  => 'Loading Bar (YouTube style)',
				...
				$this->sections[] = array(
					...
					'title' => __('Page Builder Options', 'swiftframework'),
					...
					'fields' => array(
						array(
							'id' => 'disable_spb',
							'type' => 'button_set',
							'title' => __('Disable Swift Page Builder', 'swiftframework'),
							'subtitle' => __('Enable this option to disable the Swift Page Builder', 'swiftframework'),
							'desc' => '',
				...
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							'id' => 'disable_ss',
							'type' => 'button_set',
							'title' => __('Disable Swift Slider', 'swiftframework'),
							'subtitle' => __('Enable this option to disable the Swift Slider Plugin', 'swiftframework'),
							'desc' => '',
